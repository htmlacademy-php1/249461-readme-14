<main class="page__main page__main--login">
    ...
    <section class="login container">
        ...
        <form class="login__form form" action="sign-in.php" method="post">
            <div class="login__input-wrapper form__input-wrapper <?= isset($errors['login']) ? 'form__input-section--error' : '' ?>">
                <label class="login__label form__label" for="login-email">Электронная почта</label>
                <div class="form__input-section">
                    <input class="login__input form__input" id="login-email" type="text" name="login" placeholder="Укажите эл.почту" value="<?= get_post_val('login') ?>">
            ...
            <div class="login__input-wrapper form__input-wrapper <?= isset($errors['password']) ? 'form__input-section--error' : '' ?>">
