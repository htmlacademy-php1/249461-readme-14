            ...
            <li class="post-mini post-mini--photo post user">
                ...
                <div class="post-mini__rating user__rating">
                    <p class="post-mini__rating-item user__rating-item user__rating-item--publications">
                        <span
                            class="post-mini__rating-amount user__rating-amount"><?= htmlspecialchars($subscribe['counter_posts']) ?></span>
                        <span class="post-mini__rating-text user__rating-text">
                            <?= get_noun_plural_form(htmlspecialchars($subscribe['counter_posts']), 'публикация',
                                'публикации', 'публикаций') ?>
                        </span>
                    </p>
                    <p class="post-mini__rating-item user__rating-item user__rating-item--subscribers">
                        <span
                            class="post-mini__rating-amount user__rating-amount"><?= htmlspecialchars($subscribe['followers']) ?></span>
                        <span class="post-mini__rating-text user__rating-text">
                            <?= get_noun_plural_form(htmlspecialchars($subscribe['counter_posts']), 'подписчик',
                                'подписчика', 'подписчиков') ?>
                        </span>
                    </p>
                </div>
                <div class="post-mini__user-buttons user__buttons">
                    <a href="subscribe.php?host=<?= $subscribe['id'] ?>"
