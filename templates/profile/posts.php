        ...
        <article class="profile__post post post-<?=htmlspecialchars($post['class'])?>">
            <header class="post__header">
                ...
                <div class="post__author">
                    <a class="post__author-link" href="profile.php?user=<?=htmlspecialchars($post['origin_author'])?>" title="Автор">
                        <div class="post__avatar-wrapper post__avatar-wrapper--repost">
                            <img class="post__author-avatar" src="<?=$post['origin_avatar']?>" alt="Аватар пользователя">
                        </div>
            ...
            <footer class="post__footer">
                ...
                <ul class="post__tags">
                    <?php foreach ($post['tags'] as $tag):?>
                        <li><a href="search.php?search=<?= urlencode($tag['hashtag']) ?>"><?=$tag['hashtag']?></a></li>
                    <?php endforeach;?>
                </ul>
            </footer>
            <div class="comments">
                <a class="comments__button button" href="post.php?id=<?=htmlspecialchars($post['id'])?>#comments__list">Показать комментарии</a>
            </div>
        </article>
    <?php endforeach;?>
</section>
