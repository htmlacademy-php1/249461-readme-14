                ...
                <div class="post-details__main-block post post--details">
                    ...
                    <div class="post__indicators">
                        ...
                        <span class="post__view">
                            <?= htmlspecialchars($post['views']) . ' ' . get_noun_plural_form(htmlspecialchars($post['views']),
                    ...
                    <ul class="post__tags">
                        <?php foreach ($tags as $tag) : ?>
                            <li>
                                <a href="search.php?search=<?= urlencode($tag['hashtag']) ?>"><?= htmlspecialchars($tag['hashtag']) ?></a>
                            </li>
                        <?php endforeach ?>
                    </ul>
                    <div class="comments">
                        <form class="comments__form form"
                            ...
                            <div
                                class="form__input-section <?= (count($errors) && $errors['comment']) ? 'form__input-section--error' : '' ?>">
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        <div class="post-details__avatar user__avatar">
                            <a class="post-details__avatar-link user__avatar-link"
                               href="profile.php?user=<?= $author['id'] ?>">
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span
                                class="post-details__rating-amount user__rating-amount"><?= htmlspecialchars($author['followers']) ?></span>
                            <span class="post-details__rating-text user__rating-text">
                                <?= get_noun_plural_form(htmlspecialchars($author['counter_posts']), 'подписчик',
                                    'подписчика', 'подписчиков') ?>
                            </span>
                        </p>
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span
                                class="post-details__rating-amount user__rating-amount"><?= htmlspecialchars($author['counter_posts']) ?></span>
                            <span class="post-details__rating-text user__rating-text">
                                <?= get_noun_plural_form(htmlspecialchars($author['counter_posts']), 'публикация',
