...
VALUES ('larisa@readme.loc', 'Лариса', '111111', 'userpic-larisa-small.jpg'),
       ('vladik@readme.loc', 'Владик', '111111', 'userpic.jpg'),
       ('viktor@readme.loc', 'Виктор', '111111', 'userpic-mark.jpg');
...
VALUES ('Цитата', 'Мы в жизни любим только раз, а после ищем лишь похожих', '', '', '', '', '20', '1', '2'),
       ...
       ('Пишем первую функцию', '', '', '', '', '', '35', '2', '1'),
       ('Наконец, обработал фотки!', '', '', 'rock-medium.jpg', '', '', '10', '3', '3'),
       ('Моя мечта', '', '', 'coast-medium.jpg', '', '', '16', '1', '3'),
